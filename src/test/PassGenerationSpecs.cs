...
namespace Test
{
  ...
  public class PassWriterMock : PassWriter 
  {
    ...
    public static byte[] GenerateSignature(byte[] bytes, X509Certificate2 appleCert, X509Certificate2 passCert)
    {
